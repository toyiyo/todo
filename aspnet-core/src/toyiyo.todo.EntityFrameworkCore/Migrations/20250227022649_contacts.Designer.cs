...
namespace toyiyo.todo.Migrations
{
    ...
    [Migration("20250227022649_contacts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("toyiyo.todo.Contacts.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("toyiyo.todo.Invitations.UserInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("toyiyo.todo.Jobs.Job", b =>
                {
                    ...
                    b.HasIndex("JobStatus", "Level", "TenantId");
            ...
            modelBuilder.Entity("toyiyo.todo.MultiTenancy.Tenant", b =>
                {
                    ...
                    b.Property<bool>("AllowsSelfRegistration")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("SubscriptionSeats")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("toyiyo.todo.Notifications.NotificationPreference", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("toyiyo.todo.Projects.Project", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Id", "IsDeleted");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("toyiyo.todo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("toyiyo.todo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("toyiyo.todo.Invitations.UserInvitation", b =>
                {
                    b.HasOne("toyiyo.todo.Authorization.Users.User", "InvitedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("toyiyo.todo.Jobs.Job", b =>
                {
                    ...
                    b.HasOne("toyiyo.todo.Contacts.Contact", null)
                    ...
                    b.HasOne("toyiyo.todo.Authorization.Users.User", "Owner")
                        .WithMany()
